            ...
            <div class="col pe-0">
              <div class="pe-md-7 border-0 border-end border-dark">
                <form @submit.prevent="logIn">
                  <div class="mb-3">
                    <!-- 輸入帳號密碼-->
                    <label for="loginUsername" class="form-label fs-4 text-dark"
                      >電子信箱</label
                    >
                    <input
                      type="email"
                  ...
                  <div class="mb-2">
                    <label for="loginPassword" class="form-label fs-4 text-dark"
                      >密碼</label
                    >
                ...
                <ul class="list-unstyled flex-column g-0">
                  ...
                  >
                    <a
                      ...
                      "
                    >
                      <i class="fab fa-facebook-square fs-4 pe-md-32 pe-3"></i>
                      使用 Facebook 登入</a
                    >
                  </li>
                  <li
